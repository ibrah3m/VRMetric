...
public class OverlayService extends Service {
    ...
    private void startOverlay() {
        overlayWindow = new OverlayWindow(this, new OverlayWindow.BitmapReadyCallback() {
            @Override
            public void onReady() {
        ...
        renderHandler.post(new Runnable() {
            ...
            public void run() {
                if (OverlayApplication.overlay != null && overlayWindow.getOverlayView() != null) {
                    ...
                    boolean ok = surfaceRender.renderFrame();
                    Log.i(TAG, "SurfaceRender initialized (first frame: " + ok + "), starting frame loop");
